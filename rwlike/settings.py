...
# Django settings for rwlike project.

DEBUG = False
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Charlie Denton', 'charlie@incuna.com'),
)

MANAGERS = ADMINS

EMAIL_SUBJECT_PREFIX = "[RWLike] "
...
SECRET_KEY = '86x6yt467f34vnov6%)6i()qg0dl(l*c%+b0j@1k@1e9sw3*qm'
