...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spot.credits'
        db.add_column('realworldlike_spot', 'credits', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spot.credits'
        db.delete_column('realworldlike_spot', 'credits')
    ...
    models = {
        ...
        'realworldlike.spot': {
            ...
            'credits': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
